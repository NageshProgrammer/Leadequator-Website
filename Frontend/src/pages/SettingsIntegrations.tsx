...
const SettingsIntegrations = () => {
  ...
  // ==========================================
  useEffect(() => {
    // 👈 Only run when Clerk is loaded AND a userId exists
    ...
    const fetchProfile = async () => {
      ...
      try {
        const res = await fetch(
          `${API_BASE}/api/settings/profile?userId=${clerkUser.id}`,
        );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        companyData: {
          companyName:
            profileData.companyName || profileData.name + "'s Company",
    ...
    <div className="p-4 md:p-8 space-y-6 md:space-y-8 bg-background min-h-screen text-zinc-100">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm md:text-base text-zinc-400">
          Manage your profile, company details, target market, and system
          configurations.
        </p>
      </div>
      ...
      <Tabs defaultValue="profile" className="w-full">
        <div className="overflow-x-auto pb-2 scrollbar-hide">
          <TabsList className="flex w-max md:w-full md:grid md:grid-cols-5 bg-zinc-900/50 p-1 border border-zinc-800">
            <TabsTrigger
              value="profile"
              className="px-6 md:px-0 data-[state=active]:bg-[#FFD700] data-[state=active]:text-black font-medium"
            >
              Profile & Business
            </TabsTrigger>
          </TabsList>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2 mt-3 p-4 bg-black/20 rounded-lg min-h-[100px] border border-zinc-800/50 content-start">
                          {profileData.keywords.length === 0 && (
                            <span className="text-zinc-600 text-xs self-center w-full text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(val) =>
                        setProfileData({ ...profileData, businessType: val })
                      }
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setProfileData({
                          ...profileData,
                          targetStateCity: e.target.value,
                        })
                      }
                    />
                  </div>
              ...
              <Card className="p-6 bg-zinc-900/50 border-zinc-800 flex flex-col h-full justify-between">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-xs text-zinc-500 mb-4">
                    Select where you want to monitor leads.
                  </p>
                  <div className="space-y-3">
                    {[
                      ...
                      <div
                        key={platform.id}
                        className="flex items-center justify-between p-3 rounded-lg border border-zinc-800 bg-black/40"
                      >
                        ...
                        <Switch
                          ...
                          checked={
                            profileData.platforms[
                              platform.id as keyof typeof profileData.platforms
                            ]
                          }
