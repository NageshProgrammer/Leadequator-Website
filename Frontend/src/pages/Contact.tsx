            ...
            <div className="space-y-6">
              <Card className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Demo requests are handled internally. Please submit the form
                  and our team will coordinate the schedule.
                </p>
                <Button
              ...
              <Card className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Real-time chat support is coming soon. For now, you can reach
