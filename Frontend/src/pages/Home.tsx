...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="bg-black text-white pt-32 pb-20 px-4 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          {/* Main Headline */}
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6 sm:flex items-center justify-center gap-4">
            The End of{" "}
            <SparklesText>
              {" "}
              <AuroraText>Paid Ads.</AuroraText>
            </SparklesText>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-12 text-sm text-zinc-300">
            <div className="flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-amber-500" />
              Detect buying intent across social platforms
            </div>
            <div className="flex items-center gap-2">
              <MousePointerClick className="w-4 h-4 text-amber-500" />
              Engage with prospects before competitors
            </div>
            <div className="flex items-center gap-2">
              <ShieldAlert className="w-4 h-4 text-amber-500" />
              100% compliant. Zero automation risk
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-20">
            ...
            <Link to="/working">
              <button className="bg-transparent text-white border border-zinc-700 px-8 py-4 rounded-full font-bold text-lg hover:border-amber-500 hover:text-amber-500 transition-all">
                See How It Works
              </button>
            </Link>
          </div>
          ...
          <div className="border-t border-zinc-800 pt-10">
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-16 text-zinc-400 font-medium text-lg">
              <span>Startups</span>
              <span>Agencies</span>
